...
if (pkg.version !== "1.2.4") fail(`package.json version must be 1.2.4, found ${pkg.version}.`);
else ok("Application version is 1.2.4");
...
for (const asset of ["assets/learning-academy.ico", "assets/learning-academy.png"]) {
